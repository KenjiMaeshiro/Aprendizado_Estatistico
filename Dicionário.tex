...
A partir desses dados, busca-se responder à seguinte questão: \textit{A situação socioeconômica dos alunos influencia em suas notas?}
...
Para facilitar a organização e a apresentação visual da tabela, alguns valores foram resumidos. Entretanto, no artigo final, as categorias e os valores completos serão apresentados e devidamente detalhados.
